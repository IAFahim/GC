...
public class ConfigurationTests
{
    ...
    public void ValidateConfiguration_InvalidMemorySize_ReturnsInvalid()
    {
        // Arrange
        var config = BuiltInPresets.GetDefaultConfiguration();
        config.Limits.MaxFileSize = "invalid";
    ...
    public void ValidateConfiguration_EmptyPresetExtensions_ReturnsInvalid()
    {
        // Arrange
        var config = BuiltInPresets.GetDefaultConfiguration();
        config.Presets["test"] = new PresetConfiguration
        {
    ...
    [Fact]
    public void ConfigurationLoader_LoadConfigFromNonExistentFile_ReturnsNull()
    {
        // Act
        var config = ConfigurationLoader.LoadConfigFromFile("/nonexistent/config.json");
    ...
    [Fact]
    public void ConfigurationLoader_LoadConfigFromInvalidJson_ThrowsException()
    {
        // Arrange
        ...
        try
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
                ConfigurationLoader.LoadConfigFromFile(tempFile));
        }
        finally
        {
    ...
    [Fact]
    public void ConfigurationLoader_LoadConfigFromValidJson_ReturnsConfiguration()
    {
        // Arrange
        var tempFile = Path.GetTempFileName();
        try
        {
            ...
            // Act
            var config = ConfigurationLoader.LoadConfigFromFile(tempFile);
    ...
    [Fact]
    public void ConfigurationLoader_MergeConfiguration_SourceOverridesTarget()
    {
        // Arrange
        var target = BuiltInPresets.GetDefaultConfiguration();
        ...
        // Act - Use reflection to call private MergeConfiguration method
        var mergeMethod = typeof(ConfigurationLoader).GetMethod("MergeConfiguration",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

        // For this test, we'll just verify the public API works
        var config = BuiltInPresets.GetDefaultConfiguration();
    ...
    {
        // Act
        var configDir = ConfigurationLoader.GetConfigDirectory();
    ...
    {
        // Act
        var systemConfigDir = ConfigurationLoader.GetSystemConfigDirectory();
    ...
    [Fact]
    public void ConfigurationLoader_LoadConfiguration_NoConfigFiles_ReturnsDefaults()
    {
    ...
    [Fact]
    public void BackwardCompatibility_NoConfigFiles_WorksAsBefore()
    {
        // Arrange
        ConfigurationLoader.ClearCache();
    ...
    public void ConfigurationValidator_ValidationResult_ToString_IncludesErrors()
    {
        ...
        var result = new ConfigurationValidator.ValidationResult
        {
            ...
            Warnings = new System.Collections.Generic.List<string> { "Warning 1" }
        };
